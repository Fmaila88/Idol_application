...
class _AddDataState extends State<AddData> {
  ...
  Future<String> addData() async {
    ...
    http.put(url, headers: {
      ...
      "employeeNumber": controllerContactNumber.text,
      ...
      "annualLeaveDays": controllerAnnLeaveDays.text,
      "sickLeaveDays": controllerSickLeaveDays.text,
      "familyResponsibility": controllerFamilyResponsibility.text,
